<?php /*a:2:{s:77:"D:\phpstudy\PHPTutorial\WWW\test\application\admin\view\market\bonus_log.html";i:1526991728;s:73:"D:\phpstudy\PHPTutorial\WWW\test\application\admin\view\common\world.html";i:1555177043;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
	    ...
	    <table class="table table-hover table-outline table-vcenter text-nowrap card-table">
	        <thead>
	            <tr>
	                ...
	                <th>总金额</th>
	                <th>#</th>
	                <?php $__FOR_START_1328005743__=0;$__FOR_END_1328005743__=9;for($i=$__FOR_START_1328005743__;$i < $__FOR_END_1328005743__;$i+=1){ ?>
			...
			<?php if(is_array($gbs) || $gbs instanceof \think\Collection || $gbs instanceof \think\Paginator): $a = 0; $__LIST__ = $gbs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gb): $mod = ($a % 2 );++$a;?>
				<tr>
					...
					<?php $__FOR_START_443212157__=0;$__FOR_END_443212157__=9;for($b=$__FOR_START_443212157__;$b < $__FOR_END_443212157__;$b+=1){ ?>
						<td><?php echo htmlentities($gb['lv'.$b]['count']); ?></td>
					<?php } ?>
				</tr>
				<tr>
					<th class="text-left pl-3">金额</th>
					<?php $__FOR_START_206000369__=0;$__FOR_END_206000369__=9;for($c=$__FOR_START_206000369__;$c < $__FOR_END_206000369__;$c+=1){ ?>
						<td><?php echo htmlentities($gb['lv' . $c]['money']); ?></td>
					<?php } ?>
				</tr>
				<tr>
					<th class="text-left pl-3">比例</th>
					<?php $__FOR_START_387935017__=0;$__FOR_END_387935017__=9;for($d=$__FOR_START_387935017__;$d < $__FOR_END_387935017__;$d+=1){ ?>
