<?php /*a:2:{s:69:"/www/wwwroot/amadubai.co/application/admin/view/market/bonus_log.html";i:1526991728;s:65:"/www/wwwroot/amadubai.co/application/admin/view/common/world.html";i:1530523966;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
	    ...
	    <table class="table table-hover table-outline table-vcenter text-nowrap card-table">
	        <thead>
	            <tr>
	                ...
	                <th>总金额</th>
	                <th>#</th>
	                <?php $__FOR_START_1366833377__=0;$__FOR_END_1366833377__=9;for($i=$__FOR_START_1366833377__;$i < $__FOR_END_1366833377__;$i+=1){ ?>
			...
			<?php if(is_array($gbs) || $gbs instanceof \think\Collection || $gbs instanceof \think\Paginator): $a = 0; $__LIST__ = $gbs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gb): $mod = ($a % 2 );++$a;?>
				<tr>
					...
					<?php $__FOR_START_479730305__=0;$__FOR_END_479730305__=9;for($b=$__FOR_START_479730305__;$b < $__FOR_END_479730305__;$b+=1){ ?>
						<td><?php echo htmlentities($gb['lv'.$b]['count']); ?></td>
					<?php } ?>
				</tr>
				<tr>
					<th class="text-left pl-3">金额</th>
					<?php $__FOR_START_118460975__=0;$__FOR_END_118460975__=9;for($c=$__FOR_START_118460975__;$c < $__FOR_END_118460975__;$c+=1){ ?>
						<td><?php echo htmlentities($gb['lv' . $c]['money']); ?></td>
					<?php } ?>
				</tr>
				<tr>
					<th class="text-left pl-3">比例</th>
					<?php $__FOR_START_2095561864__=0;$__FOR_END_2095561864__=9;for($d=$__FOR_START_2095561864__;$d < $__FOR_END_2095561864__;$d+=1){ ?>
