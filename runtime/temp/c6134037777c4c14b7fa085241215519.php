<?php /*a:2:{s:65:"/www/wwwroot/amadubai.co/application/index/view/funding/edit.html";i:1528733418;s:65:"/www/wwwroot/amadubai.co/application/index/view/common/world.html";i:1530681640;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<form class="card" method="post" enctype="multipart/form-data">
	<input type="hidden" name="id" value="<?php echo htmlentities($fund['id']); ?>" />
		...
		<div class="row">
			<div class="col-md-6 col-lg-6">
			    <div class="form-group">
			        ...
			        <div class="input-group">
				        <input type="text" class="form-control" placeholder="项目名称" name="title" maxlength="20" value="<?php echo htmlentities($fund['title']); ?>" />
			    	</div>
			    </div>
			</div>
			<div class="col-md-6 col-lg-6">
			...
			<div class="col-lg-12">
                <div class="form-group mb-0">
                    ...
                    <script id="editor" name="content" type="text/plain" style="height: 20rem;"><?php echo $fund['content']; ?></script>
                </div>
            </div>
		</div>
	</div>
