<?php /*a:2:{s:67:"/www/wwwroot/amadubai.co/application/index/view/contract/index.html";i:1528707650;s:65:"/www/wwwroot/amadubai.co/application/index/view/common/world.html";i:1531315458;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<div class="d-flex mb-3">
	<div class="btn-list filter">
		<button class="btn px-5 btn-primary" data-option="all">全部</button>
		<button class="btn px-5 btn-secondary" data-option="my">我的</button>
	</div>
	<div class="ml-auto">
		<select class="form-control custom-select catalog">
